...
public class Step2 {
	...
	public static class Step2_UserVectorToCooccurrenceReduce extends MapReduceBase implements Reducer<Text, IntWritable, Text, IntWritable> {
	...
	public static void run(Map<String, String> path) throws Exception {
		...
		HdfsDAO hdsf = new HdfsDAO(Recommend.HDFS, conf);
		hdsf.rmr(output);
		...
		conf.setCombinerClass(Step2_UserVectorToCooccurrenceReduce.class);
		conf.setReducerClass(Step2_UserVectorToCooccurrenceReduce.class);
